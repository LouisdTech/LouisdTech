...
- 👨‍💻 I enjoy building things that solve real problems while having fun along the way
- 🎨 When not coding, you'll find me exploring photography, design, or lost in a good book
- 💬 Ask me about anything related to Python, JavaScript, React, or creative coding!
...
- 📱 **AI Chat Assistant**: Building an intelligent chatbot with natural language processing
- 🎮 **Game Development**: Creating fun Python games and exploring game development
- 🌐 **Web Applications**: Developing responsive web apps with modern JavaScript frameworks
- 🎨 **Creative Coding**: Experimenting with generative art and interactive visualizations
